...
public class ConfirmBoxWithItem
{
	private static Map<UUID,ConfirmWithItemSession> confirmSessions = new HashMap<>();
	...
	{
		confirmSessions.put(p.getUniqueId(),new ConfirmWithItemSession(p,confirmAction,cancelAction));
	...
	public static ConfirmWithItemSession getConfirmSession(Player p)
	{
	...
	static class ConfirmWithItemSession
	{
		private UUID owner;
		private Runnable confirmAction = null;
		private Runnable cancelAction = null;
		
		public ConfirmWithItemSession(Player p,Runnable confirmAction,Runnable cancelAction)
		{

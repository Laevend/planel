...
public class ItemBuilder
{
	 ...
	 */
    public ItemBuilder(ItemStack newStack)
    {
        stack = newStack;
    }
     ...
     * native data type.
     */
    public ItemBuilder setMat(String mat)
    {
    	ItemMeta meta = this.stack.getItemMeta();
    	ItemBuilder b = setMat(MaterialUtils.getSpigotMaterial(mat));
     ...
     * @return ItemBuilder
     */
    public ItemBuilder setGradientName(String name,String... hexs) 
    {
    	if(hexs == null || hexs.length == 0) { Logg.error("No hex values were passed!"); return this; }
    	
    	ItemMeta stackMeta = stack.getItemMeta();
        stackMeta.setDisplayName(GradientUtils.applyGradient(name,hexs));
        stack.setItemMeta(stackMeta);
        return this;
    }
     ...
     * @return ItemBuilder
     */
    public ItemBuilder setGradientName(String name,LinearGradient grad) 
    {
    	ItemMeta stackMeta = stack.getItemMeta();
     ...
     * @return ItemBuilder
     */
    public ItemBuilder setCustomColourName(String name,Color colour) 
    {
    	ItemMeta stackMeta = stack.getItemMeta();
     ...
     * @return ItemBuilder
     */
    public ItemBuilder setCustomColourName(String name,String colourHex) 
    {
    	ItemMeta stackMeta = stack.getItemMeta();
     ...
     * @return ItemBuilder
     */
    public ItemBuilder setLore(String... loreStrings) 
    {
     ...
     * @return ItemBuilder
     */    
    public ItemBuilder setLore(int numberOfCharactersPerLine,boolean overflow,String loreString)
    {
     ...
     * @return ItemBuilder
     */
    public ItemBuilder addLore(String... loreStrings) 
    {
        ItemMeta meta = stack.getItemMeta();
     ...
     * @return ItemBuilder
     */
    public ItemBuilder addLore(int numberOfCharactersPerLine,boolean overflow,String loreString)
    {
    ...
    @Deprecated
	private ItemBuilder constructLinesFast(List<String> loreList,int numberOfCharactersPerLine,boolean overflow,String loreString)
    {
    	StringBuilder sb = new StringBuilder();
     ...
     * @return ItemBuilder
     */  
    private ItemBuilder constructLines(List<String> loreList,int numberOfCharactersPerLine,boolean overflow,String loreString)
    {
        ItemMeta meta = stack.getItemMeta();
     ...
     * @return ItemBuilder
     */
    public ItemBuilder addLore(List<String> loreList) 
    {
        ItemMeta meta = stack.getItemMeta();
        List<String> currentLore = getStackLore();
     ...
     * @return ItemBuilder
     */
    public ItemBuilder removeLore(String loreToRemove)
    {
    	ItemMeta meta = stack.getItemMeta();
        List<String> currentLore = getStackLore();
     ...
     * @return ItemBuilder
     */
    public ItemBuilder replaceLore(int index,String loreString)
    {
    	ItemMeta meta = stack.getItemMeta();
    	List<String> currentLore = getStackLore();
     ...
     * @return ItemBuilder
     */
    public ItemBuilder insertLore(int index,String... loreStrings)
    {
    	ItemMeta meta = stack.getItemMeta();
    	List<String> currentLore = getStackLore();
     ...
     * @return ItemBuilder
     */
    public ItemBuilder insertLore(int index,List<String> loreStrings)
    {
     ...
     * @return ItemBuilder
     */
    public ItemBuilder replaceLore(String lore,String loreLineContains) 
    {
        ItemMeta meta = stack.getItemMeta();
        List<String> currentLore = getStackLore();
     ...
     * @return ItemBuilder
     */
    public ItemBuilder replaceEnchantment(Enchantment ench,Enchantment ench2,int level)
    {
    	ItemMeta meta = stack.getItemMeta();
    	if(!meta.hasEnchants()) { return this; }
    	if(meta.hasEnchant(ench))
     ...
     * @return ItemBuilder
     */
    public ItemBuilder setEnchants(Map<Enchantment,Integer> maps)
    {
    	ItemMeta meta = stack.getItemMeta();
     ...
     * @return ItemBuilder
     */
    public ItemBuilder addAttribute(Attribute att,AttributeModifier.Operation op,double amount)
    {
    	ItemMeta meta = stack.getItemMeta();
     ...
     * @return ItemBuilder
     */
    public ItemBuilder addAttribute(Attribute att,EquipmentSlotGroup slot,AttributeModifier.Operation op,double amount)
    {
    	ItemMeta meta = stack.getItemMeta();
     ...
     * @return ItemBuilder
     */
    public ItemBuilder removeAttribute(Attribute att)
    {
    	ItemMeta meta = stack.getItemMeta();
     ...
     * @return ItemBuilder
     */
    public ItemBuilder removeAttribute(Attribute att,EquipmentSlot slot)
    {
    	ItemMeta meta = stack.getItemMeta();
     ...
     * @return ItemBuilder
     */
    public ItemBuilder setAttributes(Multimap<Attribute,AttributeModifier> attMod)
    {
    	ItemMeta meta = stack.getItemMeta();
     ...
     * @return ItemBuilder
     */
    public ItemBuilder setDurability(String dura)
    {
     ...
     * @return ItemBuilder
     */
    public ItemBuilder setCustomModelData(int customModelDataNumber)
    {
    	ItemMeta meta = stack.getItemMeta();
	 ...
	 */
	public ItemBuilder setData(String key,DType dataType,Object value)
	{
		DataUtils.set(key,dataType,value,stack);
		return this;
	}
	 ...
	 * @return ItemBuilder
	 */
	public ItemBuilder clearDataContainer()
	{
		DataUtils.clear(stack);
		DataUtils.clearJ(stack);
		return this;
	}
     ...
     * @return ItemBuilder
     */
	public ItemBuilder addMetaDataString(NamespacedKey key,String data)
	{
    	ItemMeta meta = stack.getItemMeta();
     ...
     * @return ItemBuilder
     */
	public ItemBuilder addMetaDataInteger(NamespacedKey key,int data)
	{
    	ItemMeta meta = stack.getItemMeta();
     ...
     * @return ItemBuilder
     */
	public ItemBuilder addMetaDataLong(NamespacedKey key,long data)
	{
    	ItemMeta meta = stack.getItemMeta();
     ...
     * @return ItemBuilder
     */
	public ItemBuilder addMetaDataDouble(NamespacedKey key,double data)
	{
    	ItemMeta meta = stack.getItemMeta();
     ...
     * @return ItemBuilder
     */
	public ItemBuilder removeMetaData(NamespacedKey key)
	{
    	ItemMeta meta = stack.getItemMeta();
	 ...
	 * @return ItemBuilder
	 */
	public ItemBuilder setAsSkull(ItemStack skull)
	{
